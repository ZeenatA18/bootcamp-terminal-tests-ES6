...
describe('Function should check for the profitabe department', function(){

it("Should return 'outdoor' when called with mostProfitableDepartment(salesData)", function(){
...
it("Should return 'electronics' when called with mostProfitableDepartment(salesData)", function(){
...
it("Should return 'steelwork' when called with mostProfitableDepartment(salesData)", function(){
